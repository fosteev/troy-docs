...
- HP персонажа: `base_hp + STA×15 + STR×3`. Mana: `base_mana + INT×8`.
...
|---|---|---|---|---|---|---|---|
| 1 | 59–69 | 7–8 | 1–2 | 0 | 18–20 | 7–8 | Slime, Forest Rat |
| 3 | 117 | 13 | 5 | 1 | 40 | 16 | Goblin Scout |
| 5 | 161 | 18 | 8 | 2 | 65 | 28 | Dire Wolf |
| 8 | 284 | 26 | 15 | 6 | 110 | 50 | Stone Golem |
| 10 | 332 | 33 | 16 | 10 | 160 | 80 | Drake Whelp |

Правила интерполяции для обычного моба уровня L:

```
hp        ≈ 31.5×L + 33      (танки +15%, кастеры −15%)
...
|---|---|---|---|---|---|---|
| 1 | 1 | хлебный нюк | 3–4s | ~15–25 | 20–35 | 1.0–1.2 |
| 2 | 3 | контроль (stun/slow) | 5–10s | ~20–35 | 10–18 | 0.5–0.8 |
| 3 | 6 | утилити (buff/absorb) | 18–20s | ~25 | 0 | 0–0.5 |
| 4 | 10 | тяжёлый нюк (длинный каст) | 12–15s | ~40 | 40–80 | 1.2–1.8 |

> Кап уровня — 10, ровно 4 скилла на класс. Прежние слоты 5–6 (execute, ультимативный дефанс/DoT) — резерв на поднятие капа.
...
Авто-рост за уровень в сумме = **6.5**. `baseHp`: танк ~33, кастер ~26,
середина ~29–30. `baseAttackSpeed`: 0.5 (медленный кастер) – 0.8 (мили) – 1.0
(быстрый мили).
...
- 3–4 скилла. Обязательно: минимум один с condition=self_hp_below (смена фазы)
  ...
  (у игрока-война уровня L примерно hp ≈ 110 + 37×L).
...
Результат — JSON для админки (страница Classes: форма + 4 скилла).
...
- HP = baseHp + STA×15 + STR×3. Автоатака: физ. = weapon + STR×0.8,
  маг. = spell + INT×0.5.
...
- baseHp: 26 (стекло) — 33 (танк). baseMana: 0 у MANA-класса (всё от INT),
  0 у RAGE. baseAttackSpeed: 0.5–0.8 (0.8 быстрый мили, 0.5 медленный кастер).
- Ровно 4 скилла (кап уровня 10), слоты и бюджет:
  | slot | unlockLevel | роль | CD | cost | baseDamage | scalingRatio |
  | 1 | 1  | хлебный нюк        | 3–4s   | ~15–25 | 20–35 | 1.0–1.2 |
  | 2 | 3  | контроль stun/slow | 5–10s  | ~20–35 | 10–18 | 0.5–0.8 |
  | 3 | 6  | утилити buff/absorb/heal | 18–20s | ~25 | 0 | 0–0.5 |
  | 4 | 10 | тяжёлый нюк, каст 1–2.5s | 12–15s | ~40 | 40–80 | 1.2–1.8 |
  cost для RAGE — в очках ярости (макс 100), для MANA — сопоставимо с Mage
  (15/20/25/40 при мане ~64 на 1 уровне, скиллы верхних слотов
...
3. Админка:
   - Класс: Classes → создать (isActive=false), внести атрибуты и 4 скилла
