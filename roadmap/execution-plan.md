...
- [ ] **Шаг 3Б** — Battle polish: отзывчивость и «живость» боя — см. [battle-polish.md](./battle-polish.md) — **P0+P1 done** (контракт событий + отзывчивость/читаемость/устойчивость клиента); дальше P4 — перекладка экрана по прототипу [design/prototypes/](../design/prototypes/), затем P2+P3 (ждут ассетов) и P5 — лента намерений моба
