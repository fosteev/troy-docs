...
- [ ] **Шаг 3Б** — Battle polish: отзывчивость и «живость» боя — см. [battle-polish.md](./battle-polish.md) — **P0+P1 done** (контракт событий + отзывчивость/читаемость/устойчивость клиента); P2+P3 ждут ассетов, P4 — лента намерений моба
